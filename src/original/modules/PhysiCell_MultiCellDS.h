...
void save_PhysiCell_to_MultiCellDS_xml_pugi(std::string filename_base, biofvm::microenvironment& M,
...
void add_PhysiCell_cells_to_open_xml_pugi_v2(pugi::xml_document& xml_dom, std::string filename_base,
											 biofvm::microenvironment& M);
void save_PhysiCell_to_MultiCellDS_v2(std::string filename_base, biofvm::microenvironment& M,
									  double current_simulation_time);
